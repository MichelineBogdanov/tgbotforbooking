...
public interface MessagesText {
    ...
    String CHOOSE_DURATION_TEXT = """
            Для того чтобы получить расписание необходимо выбрать длительность вашей услуги📝
            Расписание подстроится под длительность услуги🕐
            Услуги могут длиться 30/60/90 минут
            """;
    ...
    String CHOOSE_SERVICE_TEXT = """
            Сначала, по возможности, выберите услугу📝
            * порядковый номер услуги соответствует номеру на кнопке🙂
            * если вы не знаете на какую услугу надо записаться, выбирайте консультацию, либо проконсультируйтесь со специалистом🙂
            * предложенное время будет зависеть от выбранной услуги
    ...
    String ERROR_BOOKING_TEXT = "Что-то пошло не так, обратитесь к специалисту😟";
