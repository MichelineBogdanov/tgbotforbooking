package ru.bogdanov.tgbotforbooking.serviсes.telegram.callbacks.visit_deals.cancel_visit;
...
import ru.bogdanov.tgbotforbooking.serviсes.telegram.callback_data_entities.ChooseCancelVisitCallbackData;
...
public class CancelVisitCallback implements CallbackHandler {
    ...
    public CancelVisitCallback(@Qualifier("googleCalendarService") CalendarAPI service) {
