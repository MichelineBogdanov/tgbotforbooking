...
import ru.bogdanov.tgbotforbooking.services.telegram.callback_data_entities.*;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.account.GetFutureVisitsCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.account.GetVisitsHistoryCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.account.UserNotificationSwitchCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.common.BackCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.general_info.PlaceInfoCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.general_info.ScheduleInfoCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.general_info.ServicesInfoCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.visit_deals.cancel_visit.CancelVisitCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.visit_deals.cancel_visit.ChooseCancelVisitCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.visit_deals.create_visit.ChooseDayCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.visit_deals.create_visit.ChooseServiceCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.visit_deals.create_visit.ChooseTimeCallback;
import ru.bogdanov.tgbotforbooking.services.telegram.callbacks.visit_deals.create_visit.CreateVisitCallback;
